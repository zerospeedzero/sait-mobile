          ...
          {filledEvents.map((event, index) => (
            ...
            >
              ...
              <div className='flex flex-row justify-between items-start'>
                <p className='mb-2' dangerouslySetInnerHTML={{ __html: event.description }}></p>
                <img src={event.thumbnail} className='w-[6rem] rounded-md ml-4 border-white border-2' />
              </div>
              <div className='flex flex-row justify-start items-center mb-4'>
                <p className='font-semibold mr-4`'>Event date:&nbsp;</p>
              ...
              <div className='w-full flex flex-row justify-end'>
                { event.link && (
                    <Link href={event.link }
                      className='px-4 py-2 bg-p2  shadow-md rounded-md hover:scale-110 hover:bg-s2 duration-200'
                    >
                      Details
                    </Link> 
                )}
